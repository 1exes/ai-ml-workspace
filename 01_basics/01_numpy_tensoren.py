...
Hier lernst du die Grundlagen, die du für alles Weitere brauchst.
"""
...
# 3D Tensor - z.B. ein Batch von Bildern (batch, höhe, breite)
tensor_3d = np.random.randn(2, 3, 4)  # 2 Bilder, 3x4 Pixel
print(f"\n3D Tensor Shape: {tensor_3d.shape}")

# ============================================================
# 2. Wichtige Operationen für ML
# ============================================================
...
# XOR: Die einfachste Aufgabe, die ein einzelnes Neuron NICHT lösen kann
